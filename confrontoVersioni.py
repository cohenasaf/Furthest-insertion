...
for l in TSP_LIB[:50]:
    ...
    fO.append(testEuristicO("furthestInsertionOttimizzato", t.furthestInsertionOttimizzato, dF[l]))
    fA.append(testEuristic("furthestInsertionApprossimato", t.furthestInsertionApprossimato))

print("Cheapest Tempi")
print([x[1] for x in cOn3])
print([x[1] for x in c])
print([x[1] for x in cO])
print([x[1] for x in cA])
print("Cheapest Qualità")
print([x[0] for x in cOn3])
print([x[0] for x in c])
print([x[0] for x in cO])
print([x[0] for x in cA])

print("Furthest Tempi")
print([x[1] for x in fOn3])
print([x[1] for x in f])
print([x[1] for x in fO])
print([x[1] for x in fA])
print("Furthest Qualità")
print([x[0] for x in fOn3])
print([x[0] for x in f])
print([x[0] for x in fO])
print([x[0] for x in fA])
