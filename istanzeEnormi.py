...
for l in TSP_LIB[50:-2]:
    ...
    CI.append(testEuristicO("cheapestInsertionOttimizzato", t.cheapestInsertionOttimizzato, 3))
...
print("MEDIE TEMPI'")
print(np.mean([x[1] for x in NN]))
print(np.mean([x[1] for x in NI]))
print(np.mean([x[1] for x in CI]))
print(np.mean([x[1] for x in FaI]))
print(np.mean([x[1] for x in FuI]))
print("VARIANZA TEMPI'")
print(np.var([x[1] for x in NN]))
print(np.var([x[1] for x in NI]))
print(np.var([x[1] for x in CI]))
print(np.var([x[1] for x in FaI]))
print(np.var([x[1] for x in FuI]))