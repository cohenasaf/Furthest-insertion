...
for l in TSP_LIB:
    ...
    t.calculateCost()
    assert t.verifyTour()
    print(f"nearestInsertion, costo: {t.cost}, tempo: {et - st} secondi.")
    r.append(t.cost)
    ...
    t.calculateCost()
    assert t.verifyTour()
    print(f"cheapestInsertion, costo: {t.cost}, tempo: {et - st} secondi.")
    r.append(t.cost)
    ...
    t.calculateCost()
    assert t.verifyTour()
    print(f"nearestNeighbor, costo: {t.cost}, tempo: {et - st} secondi.")
    r.append(t.cost)
    ...
    t.calculateCost()
    assert t.verifyTour()
    print(f"farthestInsertion, costo: {t.cost}, tempo: {et - st} secondi.")
    r.append(t.cost)
    ...
    t.calculateCost()
    assert t.verifyTour()
    print(f"furthestInsertion, costo: {t.cost}, tempo: {et - st} secondi.")
    r.append(t.cost)
