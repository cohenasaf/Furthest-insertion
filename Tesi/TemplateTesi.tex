...
\begin{tcolorbox}[colframe=black, colback=white, boxrule=0.5pt, title=Cheapest Insertion Versione 3 Approssimata, coltitle=black, fonttitle=\bfseries, colbacktitle=white]
  \begin{algorithmic}[1]
    \While{$len(path) < n$}
      \State \dots
      \For{$hp \in h$}
...
\begin{tcolorbox}[colframe=black, colback=white, boxrule=0.5pt, title=Furthest Insertion Versione 2 Approssimata, coltitle=black, fonttitle=\bfseries, colbacktitle=white]
  \begin{algorithmic}[1]
    \State ...
    \While{$len(path) < n$}
      \State \dots
