...
\begin{legal}
  ...
  \end{legal}
\end{legal}
\hfill \break Random Insertion ha complessità computazionale pari a $O(n^2)$ in quanto n volte viene selezionato un nodo casuale, dopodiché n volte è necessario iterare alla ricerca della posizione migliore dove inserire il nodo.
