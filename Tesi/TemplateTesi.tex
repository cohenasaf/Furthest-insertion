...
\section{Improving Solution Euristics}
Le euristiche "Improving Solutions" sono euristiche che implementano un meccanismo che consente di migliorare una soluzione parziale trovata, il meccanismo può ad esempio scambiare due nodi nel tour (vedremo nel dettaglio una euristica in particolare) oppure implementare meccanismi più sofisticati che consentono di ottenere tour con un costo totale più basso.
%
%
