...
\end{myverbatim}
Ovvero percentuali \textgreater 99\%. Dopo questa osservazione è possibile applicare questa semplice modifica all'implementazione:
\begin{python}
